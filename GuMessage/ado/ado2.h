...
class CADODatabase : public IDatabase
{
public:
	...
	//int Open(LPCTSTR sqlData){return Open(m_strConnection,lpstrUserID,lpstrPassword);}
	_ConnectionPtr GetActiveConnection() 
		{return m_pConnection;};
	
	BOOL Execute(LPCTSTR lpstrExec);
	
	BOOL Execute(LPCSTR lpstrExec);
	...
	void SetConnectionTimeout(long nConnectionTimeout = 5)
...
class CADORecordset : public IRecoredset
{
public:
	...
	CDataTable* GetDt(CDataTable* dt);
	...
	BOOL Open( LPCSTR lpstrExec = "", int nOption = IRecoredset::openUnknown, CDataTable* pDt = NULL );

	BOOL Open(LPCTSTR lpstrExec = _T(""), int nOption = CADORecordset::openUnknown,CDataTable* pDt=NULL);
